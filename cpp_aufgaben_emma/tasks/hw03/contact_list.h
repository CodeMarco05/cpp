 ...
 *
 * you may adjust this struct to store the data differently, or add index
 * structures, ... this is fine as long as the API of the functions below
 * remains the same.
 */
struct storage {
...
// functions for dealing with the contact list storage - this is your contact
// list API. you have to implement them - and we check if they behave as
// expected.
